...
if submitted:
    ...
    with res_col:
        ...
        <div style="background:{info['bg']};border:1.5px solid {info['border']};
            ...
            <div style="font-size:14px;color:#4b5563;margin-bottom:20px;">{info['desc']} Your reported symptoms and vital match patients typically directed to this departement.</div>
            <div style="font-size:11px;font-weight:600;color:{info['color']};text-transform:uppercase;
    ...
    with prob_col:
        ...
        <div style="background:white;border:1px solid #e5e7eb;border-radius:16px;padding:24px;">
            <div style="fon-size:14px;font-weight:600;color:#111827;margin-bottom:16px;">
